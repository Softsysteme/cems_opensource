...
//        i18n: "" /** in case of multi-language application, force usage of the language selected. Empty string will select the browser language */
     ...
     */
    ro_vars: {
        i18n_files: ["en", "fr"] /** list of language available for the application. The first is the default language. The application must have an i18n folder with 1 file per language like: i18n/en.json */
    },
...
//        }
        ...
        {
        	// We are checking if the user is logged in, and getting data for the left panel
		    calledRequest: "lib_APIStore.User_getSession",
		    actions: [{
        ...
        {
		    calledRequest: "lib_APIStore.User_login",
		    actions: [{
		...
		{
        	// The user logged out
		    calledRequest: "lib_APIStore.User_logout",
		    actions: [{
	        	beforeRendering: session.set,
	        	goToPage: "app.html"
	        }]
		...
		{
			calledRequest: "lib_APIStore.User_deleteSelf",
			actions: [{
				beforeRendering: session.set,
				goToPage: "app.html"
			}]
		...
		{
			calledRequest: "lib_APIStore.User_deleteSubscription",
			actions: [{
				condition: function(_, c8oData) { return c8oData.goHome; },
				goToPage: "app.html"
			}]
		},

		{
        	// We are showing an API's details
		    calledRequest: "lib_APIStore.User_getAPIs",
		    actions: [{
	    		goToPage: "getAPIs.html",
	        	afterRendering: afterRendering.getAPIs
	        }]
		},

		{
        	// We are showing an API's details
		    calledRequest: "lib_APIStore.User_getAPI",
		    actions: [{
		...
		{
			calledRequest: "lib_APIStore.User_getSelf",
		    actions: [{
	        	goToPage: "putSelf.html"
	        }]
		},
		{
			calledRequest: "lib_APIStore.User_getSubscription",
		    actions: [{
	        	goToPage: "getSubscription.html",
	        	afterRendering: afterRendering.getSubscription
	        }]
		},

		{
			calledRequest: "lib_APIStore.User_getSubscriptions",
		    actions: [{
	        	goToPage: "getSubscriptions.html"
	        }]
		},

		{
			calledRequest: "lib_APIStore.User_putSelf",
		    actions: [{
	    		beforeRendering: session.set,
	        	goToPage: "app.html"
	        }]
		...
		{
			calledRequest: "lib_APIStore.User_putUser",
		    actions: [{
	        	goToPage: "app.html"
	        }]
		},
		{
			calledRequest: "lib_APIStore.User_putSubscription",
			actions: [{
				beforeRendering: function() {
					$(".ui-page-active div[data-role=popup]").popup("open");
				}
			}]
		}
    ]
