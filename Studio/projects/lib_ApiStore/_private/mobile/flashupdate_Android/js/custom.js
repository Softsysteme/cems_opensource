...
//        }
        ...
        {
            calledRequest: ".getConfig",
            actions: [
                {
                	condition: function(_, c8oData) {
                		return !!c8oData.is_edit;
                	},
                    goToPage: "updateConfig.html",
                },
                {
        ...
        {
            calledRequest: ".getEndPoint",
            actions: [
                {
                	condition: function(_, c8oData) {
                		return !!c8oData.is_edit;
                	},
                    goToPage: "updateEndPoint.html",
                },
                {
        ...
        {
            calledRequest: ".newAPI",
            actions: [{
                goToPage: "getAPI.html",
            }]
        },
        {
            calledRequest: ".newConfig",
            actions: [{
                goToPage: "getConfig.html",
            }]
        },
        {
            calledRequest: ".newEndPoint",
            actions: [{
                goToPage: "getEndPoint.html",
            }]
        }
