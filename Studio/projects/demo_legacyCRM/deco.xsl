...
<!--	<xsl:include href="../../xsl/headerfooter.xsl" /> -->
	...
	<xsl:include href="templates/tablex.xsl" />
	...
	<xsl:include href="templates/buttonsPanel.xsl" />
	...
	<xsl:include href="templates/container.xsl" />
	...
	<xsl:template name="generate-page">
		<div id="generated_page">
			<form id="javelin_form" name="javelin_form" method="post" onSubmit="">
