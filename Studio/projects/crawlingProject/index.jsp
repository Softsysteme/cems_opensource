...
<%	String	data = "";
	...
	admin = !params;
	if (params)
		contextName = request.getParameter("__context");
%>
...
%>
		<script type="text/javascript" defer="false">
			twsInit();
			ajaxXmlPostDataContext(ajax, "<%=data%>", <%=contextName==null?null:"'"+contextName+"'"%>);
		</script>
<%	} else {
%>	
		...
		<table width="100%" border="0" cellpadding="0" cellspacing="10">
			<tr>
				<td align="left" valign="top">
					<p><img src="../../admin/images/logo-ems-datasheet-300pix.png"></p>
				</td>
									...
									<tr>
										<td>
											<table cellpadding="2" width="100%">
												<tr>
													<td class="properties-group"><small><%=projectComment%></small></td>
												</tr>
												<tr>
